...
new_diabetic_readmission_data <- subset(diabetic_readmission_data_iid, select = -c(weight, payer_code, medical_specialty))
...
```{r}
table(diabetic_readmission_data$metformin)
```
